...
export default function ResidentChartModal({ isOpen, onClose, resident, initialChart = null }) {
    ...
    return (
        <div className="behavior-chart-modal fixed inset-0 z-50 flex items-center justify-center p-4 backdrop-blur-sm overflow-y-auto" style={{ backgroundColor: 'rgba(0,0,0,0.4)' }}>
