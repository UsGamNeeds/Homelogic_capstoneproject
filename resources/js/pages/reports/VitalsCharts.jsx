        ...
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                <SectionCard>
                    ...
                    <p className="text-3xl font-bold text-[#25603E] mt-2">{data?.total_vitals || 0}</p>
                </SectionCard>
                <SectionCard>
                    <p className="text-gray-600 text-sm font-medium">Today</p>
                    <p className="text-3xl font-bold text-[#25603E] mt-2">{data?.today_vitals || 0}</p>
                </SectionCard>
                <SectionCard>
                    <p className="text-gray-600 text-sm font-medium">This Week</p>
                    <p className="text-3xl font-bold text-[#25603E] mt-2">{data?.week_vitals || 0}</p>
                </SectionCard>
                <SectionCard>
                    <p className="text-gray-600 text-sm font-medium">This Month</p>
                    <p className="text-3xl font-bold text-[#25603E] mt-2">{data?.month_vitals || 0}</p>
                </SectionCard>
            </div>
